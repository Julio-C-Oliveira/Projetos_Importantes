...
class FedT(object):
    ...
    def aggregate_trees(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/fedT.FedT/aggregate_trees',
    ...
    def get_server_model(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/fedT.FedT/get_server_model',
    ...
    def get_server_settings(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/fedT.FedT/get_server_settings',
            fedT__pb2.Request_Server.SerializeToString,
    ...
    def end_of_transmission(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/fedT.FedT/end_of_transmission',
            fedT__pb2.Request_Server.SerializeToString,
