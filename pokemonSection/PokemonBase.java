...
public interface PokemonBase {
    ...
    boolean carryOutAttack(PokemonBase target); // Seleciona um dos movimentos disponiveis e o utiliza.
    // boolean uniqueClassSkill(PokemonBase target); // Pode dar problema.
}